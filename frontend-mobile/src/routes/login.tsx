...
export const Route = createFileRoute("/login")({
    ...
    head: () => ({
        meta: [
            { title: "Login · PetPrev VetCampo" },
            { name: "description", content: "Acesse o aplicativo PetPrev com seu número de telefone." },
        ],
    }),
});
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="mb-8 flex flex-col items-center gap-3">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">App do Tutor & Veterinário</p>
                    </div>
                </div>

                {/* Card */}
                <div className="rounded-2xl border border-border/60 bg-card/80 p-6 sm:p-8 shadow-2xl backdrop-blur-sm">
                    {step === "phone" ? (
                        <PhoneStep
                            phone={phone}
                            setPhone={setPhone}
...
function PhoneStep({
    ...
    return (
        <div>
            <h2 className="font-display text-xl font-semibold text-foreground">Acesso ao App</h2>
            <p className="mt-1 text-sm text-muted-foreground">Informe seu número de telefone para receber o código.</p>
                ...
                <div className="flex justify-center gap-1.5 sm:gap-2">
                    {otp.map((digit, i) => (
                        <input
                            ...
                            className={`size-10 sm:size-12 rounded-xl border text-center text-lg font-bold text-foreground transition-all focus:outline-none focus:ring-2 focus:ring-primary/20
                ${success
